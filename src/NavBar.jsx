    ...
    return (
        <div className="navbar bg-base-100 mb-8  shadow-xl">
            <div className="navbar-start">
                ...
                <img className="w-32 rounded-lg hidden lg:block md:block " src="https://i.ibb.co/dKwVhcc/360-F-520648703-8-Fb-St-HNv-E9pi9-SD1q-Gqac-Wm-Qplqjlr-Ps.jpg" alt="" />
            ...
            <img className="w-32 rounded-lg lg:hidden md:hidden  " src="https://i.ibb.co/dKwVhcc/360-F-520648703-8-Fb-St-HNv-E9pi9-SD1q-Gqac-Wm-Qplqjlr-Ps.jpg" alt="" />
